...
const GradientIcon = ({ fill = 'currentColor' }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M3 2H21C22.103 2 23 2.898 23 4V20C23 21.103 22.103 22 21 22H3C1.897 22 1 21.103 1 20V4C1 2.898 1.897 2 3 2ZM3 4V20H21.001L21 4H3Z"
    />
