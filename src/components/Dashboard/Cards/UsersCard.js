...
const UsersCard = ({
  ...
  useEffect(() => {
    if (info.response && info.response.user) {
      setData(info.response.user)
    }
  }, [info])
  ...
  return (
    <Grid item className={classes.cardWrapper}>
      <Card
        ...
        title={t('Dashboard Card Title Users')}
        menuItems={[{ label: t('Users Library dashboard action'), url: '' }]}
      >
...
export default translate('translations')(
  withStyles(styles)(connect(mapStateToProps, null)(UsersCard))
)
